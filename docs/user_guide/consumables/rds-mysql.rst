...
The component launches Managed database Resource based on MySQL engine.  The resource is configured according to properties and default set out below.
...
.. literalinclude:: ../samples/rds-mysql-quickstart.yaml
  :language: yaml
  :caption: AWS::RDS::MySQL Quick Start
