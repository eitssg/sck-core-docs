...
The component launches Managed database Resource based on MariaDB engine.  The resource is configured according to properties and default set out below.
...
.. literalinclude:: ../samples/rds-mariadb-quickstart.yaml
  :language: yaml
  :caption: AWS::RDS::MariaDB Quick Start
