...
The component creates an Amazon Aurora DB cluster in MySQL mode. You can only create this resource in regions where Amazon Aurora is supported. The default DeletionPolicy for DBCluster resources is Snapshot. The resource is configured according to properties and default set out below.
...
.. literalinclude:: ../samples/rds-aurora-mysql-quickstart.yaml
  :language: jinja
  :caption: AWS::RDS::Aurora::MySQL Quick Start
